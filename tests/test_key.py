...
class TestCase(unittest.TestCase):
    ...
    def test_get_key_from_api_call(self):
        ...
        assert (
            get_key(key="123456789012345678901234567890123456")
    ...
    def test_key_1(self):
        ...
        assert (
            get_key(key="", filename="umbrella_example.json")
            == "YOUR-CUSTOMER-KEY-IS-HERE-0123456789"
        )
    ...
    def test_key_2(self):
        ...
        assert (
            get_key(key=None, filename="umbrella_example.json")
            == "YOUR-CUSTOMER-KEY-IS-HERE-0123456789"
        )
    ...
    def test_incorrect_json(self):
        ...
        json_test_file = os.path.join(
            os.path.dirname(__file__), "data", "umbrella_incorrect.json"
        )
